            ...
            <div className="project_img">
              <div className="slider-container">
                ...
                <div className="slider-pagination">
                  {SuwonImgs
                    .slice(
                      Math.max(0, Math.min(currentIndex - 2, SuwonImgs.length - 5)), // 시작 인덱스
                      Math.min(SuwonImgs.length, Math.max(currentIndex + 3, 5)) // 끝 인덱스
                    )
                    .map((_, index) => {
                      const actualIndex = Math.max(0, Math.min(currentIndex - 2, SuwonImgs.length - 5)) + index;
          ...
          <div className="project_des">
            ...
            <div className="project_txt2">
              ...
              <div className="project_txt2_2">
                ...
                <b>&bull; Vervion Control:</b> Git, GitLab, Sourcetree<br />
